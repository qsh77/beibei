  ...
  <div class="admin-workers">
        ...
        <el-form :model="searchForm" inline>
          ...
          <el-form-item>
            <el-select
              ...
              @change="handleSearch"
            >
              <el-option label="分数：高到低" value="scoreDesc" />
              <el-option label="分数：低到高" value="scoreAsc" />
            </el-select>
          </el-form-item>
    ...
    <div class="table-section">
      ...
      >
        ...
        <el-table-column prop="score" label="评分/等级" width="180">
          <template #default="{ row }">
            <div class="score-wrapper">
              <el-rate
                :model-value="row.score || 0"
                disabled
                allow-half
                :colors="['#99A9BF', '#F7BA2A', '#FF9900']"
              />
              <span class="score-text">{{ row.score ? row.score.toFixed(1) : '暂无评价' }}</span>
            </div>
          </template>
        </el-table-column>
