...
import { getAdminProfile, updateAdminProfile } from '@/api/admin.js'
import { uploadAvatar as uploadAvatarApi } from '@/api/user.js'
...
const uploadAvatar = async (options) => {
  try {
    ...
    // 使用真实的文件上传API
    const response = await uploadAvatarApi(options.file)
