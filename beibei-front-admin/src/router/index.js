...
const adminRoutes = [
  {
    ...
    children: [
      ...
      },
      {
        ...
        meta: { title: '个人设置', requiresAuth: true, requiresRole: 'ADMIN' }
      }
    ]
  }
]
...
const workerRoutes = [
  {
    ...
    children: [
      ...
      },
      {
        ...
        meta: { title: '收入管理', requiresAuth: true, requiresRole: 'WORKER' }
      },
      {
        path: 'schedule',
        name: 'WorkerSchedule',
...
router.beforeEach(async (to, from, next) => {
  ...
  // 设置页面标题
  document.title = to.meta.title ? `${to.meta.title} - 贝贝家政后台` : '贝贝家政后台'
